...
Route::middleware(['auth:api_encargado'])->group(function () {
    ...
    Route::put('/devueltoalmacen5/{solicitude}', 'SolicitudeController@markAsDevueltoAlmacen');
    ...
    Route::put('/recibirpaquetes/{solicitude}', 'SolicitudeController@RecibirPaquete');
